...
public:
	...
	FORCEINLINE Matrix2x2 operator*(float InSalar) const;
...
inline Matrix2x2 Matrix2x2::operator*(float InSalar) const
{
	return Matrix2x2(Cols[0] * InSalar, Cols[1] * InSalar);
}
